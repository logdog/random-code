...
public class Sprite {
	...
	public static Sprite overGrassDay = new Sprite(16, 1, 0, SpriteSheet.overworldTiles);
	public static Sprite overWoodDay = new Sprite(16, 0, 1, SpriteSheet.overworldTiles);
